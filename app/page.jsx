    ...
    <div className="space-y-2">
      {links.map((link, index) => (
        <a
          ...
          className="group flex items-center text-primaryColor hover:text-indigo-800 transition-colors"
        >
          {link.name}
...
export default function ResourcesPage() {
  ...
  const resourceCategories = {
    tech: {
      icon: <Code className="w-10 h-10 text-primaryColor" />,
      resources: [
        {
        ...
        },
        {
          ...
          icon: <Target className="w-8 h-8 text-primaryColor" />,
          links: [
    ...
    aptitude: {
      icon: <Brain className="w-10 h-10 text-primaryColor" />,
      resources: [
        {
          title: "Aptitude & Reasoning",
          description: "Practice quantitative and logical reasoning skills",
          icon: <PenTool className="w-8 h-8 text-primaryColor" />,
          links: [
        ...
        },
        {
          ...
          icon: <Award className="w-8 h-8 text-primaryColor" />,
          links: [
    ...
    interview: {
      icon: <FileText className="w-10 h-10 text-primaryColor" />,
      resources: [
        {
          title: "Interview Guides",
          description: "Comprehensive interview preparation resources",
          icon: <Book className="w-8 h-8 text-primaryColor" />,
          links: [
        ...
        },
        {
          ...
          icon: <Globe className="w-8 h-8 text-primaryColor" />,
          links: [
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16 space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                Best Interview & Preparation Resources
              </h1>
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive collection of resources to support your
                professional growth and interview preparation
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    icon: (
                      <Book className="w-12 h-12 text-primaryColor mx-auto mb-4" />
                    ),
                  ...
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group-hover:text-indigo-800 text-primaryColor flex items-center justify-center"
                    >
                      Explore
