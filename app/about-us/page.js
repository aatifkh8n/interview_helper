...
const AboutUsPage = () => {
  ...
  const tabContent = {
    mission: {
      icon: <Target className="mr-2 text-primaryColor" />,
      content: (
    ...
    story: {
      icon: <BookOpen className="mr-2 text-primaryColor" />,
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">
    ...
    approach: {
      icon: <Rocket className="mr-2 text-primaryColor" />,
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">
  ...
  const coreValues = [
    {
      icon: <Award className="w-12 h-12 text-primaryColor mb-4" />,
      title: "Continuous Learning",
      description:
        "Always striving to improve and provide better tools for growth.",
    },
    {
      icon: <Users className="w-12 h-12 text-primaryColor mb-4" />,
      title: "Empowerment",
      description:
        "Supporting individuals in building confidence and achieving professional success.",
    },
    {
      icon: <Briefcase className="w-12 h-12 text-primaryColor mb-4" />,
      title: "Excellence",
      description:
            ...
            {Object.keys(tabContent).map((tab) => (
              <button
                ...
                className={`w-full sm:flex-1 py-3 sm:py-4 px-4 sm:px-6 flex items-center justify-center 
                  ${
                    activeTab === tab
                      ? "bg-indigo-50 text-indigo-700 border-b-2 border-primaryColor"
