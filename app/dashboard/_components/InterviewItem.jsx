...
import { Trash2, Play, BotMessageSquare, FileUp } from "lucide-react";
...
const InterviewItem = ({ interview, index }) => {
  ...
  return (
    <tr>
      ...
      <td class="px-6 py-4">{interview?.jobExperience || "N/A"}</td>
      <td class="px-6 py-4">{interview?.createdAt}</td>
